...
Target.create(first_name: "Nettie", last_name: "Kliger", zip: "94702", address: "", city: "", state: "TX", salutation: "Hi Mom", email: "bkliger@comcast.net", rec_email: "1", rec_text: "1", phone: "203-234-3333", user_id: u2.id)
Target.create(first_name: "Billie", last_name: "James", zip: "77450", address: "4315 Cannondale Lane", city: "Katy", state: "TX",  salutation: "Hi Dad", email: "bkliger@comcast.net", rec_email: "1", rec_text: "0", phone: "203-234-3333", user_id: u1.id)
