...
Target.create(first: "Nettie", last: "Kliger", zip: "94702", address: "", city: "", state: "CA", salutation: "Hi Mom", email: "bkliger@comcast.net", rec_email: "1", rec_text: "1", phone: "203-234-3333", user_id: u2.id)
Target.create(first: "Billie", last: "James", zip: "94702", address: "1335 Santa Fe Ave", city: "Berkeley", state: "CA",  salutation: "Hi Dad", email: "bkliger@comcast.net", rec_email: "1", rec_text: "0", phone: "203-234-3333", user_id: u1.id)
